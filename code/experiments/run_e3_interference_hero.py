...
Run:
  python3 code/experiments/run_e3_interference_hero.py --trials 200
  python3 code/experiments/run_e3_interference_hero.py --trials 200 --naïve-batch 256
...
def main():
    ...
    print("  nsys profile --stats=true python3 code/experiments/run_e3_interference_hero.py --cupti")
