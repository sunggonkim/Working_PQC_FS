...
The intended use is:
  ...
  python3 code/experiments/build_repro_bundle.py --out-dir artifacts/repro_bundle
...
def main() -> int:
    ...
    commands = {
        ...
        "microbench": [
            "python3 code/experiments/run_verified_microbench.py --runs 3 --out artifacts/validation/microbench",
            "python3 code/experiments/plot_verified_microbench.py",
        ],
        "qos": [
            "python3 code/experiments/run_m5_admission_sweep.py",
            "python3 code/experiments/run_qos_gpu.py",
            "PQC_SUDO_PASSWORD=<password> python3 code/experiments/run_qos_cupti_pm_fuse_bridge.py --out-dir artifacts/validation/qos_cupti_pm_fuse_bridge --samples 8 --cupti-iterations 600 --sampling-interval 1000000 --max-samples 512",
        ],
        "crash_recovery": [
            "python3 code/experiments/run_crash_replay_e8.py",
            "python3 code/experiments/run_fuse_tamper_rejection.py",
            "python3 code/experiments/run_app_recovery_bundle.py",
            "PQC_SUDO_PASSWORD=<password> python3 code/experiments/run_combined_durability_bundle.py --out-dir artifacts/validation/combined_durability_bundle",
            "PQC_SUDO_PASSWORD=<password> python3 code/experiments/run_sqlite_syscall_crash_tpm.py --out-dir artifacts/validation/sqlite_syscall_crash_tpm --when 1 2 3",
        ],
    }
