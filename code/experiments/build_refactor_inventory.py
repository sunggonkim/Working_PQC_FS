...
def build_phase1_behavior_equivalence(source_ownership: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "preserved_behavior_contract": [
            ...
            "AES-GCM block nonce, AAD, tag, journal digest, metadata HMAC, checkpoint HMAC, logical-size xattr, storage-root path resolution, hidden sidecar, internal xattr filtering, SQLite WAL/SHM redirect, and QoS xattr parsing behavior are preserved by this extraction.",
