...
def main() -> int:
    ...
    checks = []
    checks.append(run_cmd(["python3", "code/experiments/run_tpm_freshness_bundle.py"], out_dir, "tpm_freshness_bundle"))
    checks.append(run_cmd(["python3", "code/experiments/build_tpm_freshness_report.py"], out_dir, "tpm_freshness_report"))
