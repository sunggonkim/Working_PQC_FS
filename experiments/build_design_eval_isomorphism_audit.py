...
MECHANISMS = [
    ...
    },
    {
        ...
        "evaluation_needles": ["daemon power-fault campaign", "SQLite WAL/FULL selected-boundary", "oracle verdict"],
        "rq": "RQ4",
        "artifact_paths": [
    ...
    {
        "mechanism": "TPM freshness",
        "closure_id": "E3-hardware-freshness-verdict-matrix",
        "design_needles": ["TPM NV index", "Freshness boundary"],
        "evaluation_needles": ["hardware-freshness recovery matrix", "TPM replay-after-advance"],
        "rq": "RQ4",
        "artifact_paths": [
    ...
    },
    {
        ...
        "evaluation_needles": ["SQLite transaction latency", "sensitivity bundle", "hysteresis trace"],
        "rq": "RQ3/RQ5",
        "artifact_paths": [
    ...
    },
    {
        ...
        "design_needles": ["optional batched ML-KEM", "key-plane workflow", "producer supplies nonzero relative slack"],
        "evaluation_needles": ["ML-KEM-768", "1.158$\\times$ speedup", "open-file envelope refresh"],
        "rq": "RQ5",
        "artifact_paths": [
...
FIGURE_TABLE_OBLIGATIONS = [
    ...
    {"label": "fig:baseline_comparison", "source": "Paper/4_Evaluation.tex", "obligation": "placement evidence"},
    {"label": "tab:recovery_scope", "source": "Paper/4_Evaluation.tex", "obligation": "freshness/recovery interpretation"},
...
def build_report() -> dict[str, Any]:
    ...
    mapping_text_present = (
        ...
        and "optional ML-KEM lane closes through the mounted open-file rekey workflow" in eval_text
    )
