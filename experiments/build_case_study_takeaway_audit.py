...
BOUNDARY_TERMS = [
    "kernel-encryption replacement",
    "TensorRT p99 recovery",
    "unmanaged power loss",
    "CUDA-independent deployment",
]
...
def build_report() -> dict[str, Any]:
    ...
    checks = {
        ...
        "hero_id_matches_takeaway": bool(hero_id) and hero_id in takeaway,
