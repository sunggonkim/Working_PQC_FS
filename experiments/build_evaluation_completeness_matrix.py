...
MATRIX_ROWS: list[dict[str, Any]] = [
        ...
        "paper_anchors": [
            {
                ...
                "terms": [
                    "plaintext warm-cache row reports",
                    "gocryptfs reports",
                    "AEGIS-Q warm-cache row reports",
                    "broader kernel-encryption rows are discussed",
                ],
            },
            {
                "path": "Paper/10_Discussion_and_Limitations.tex",
                "terms": [
                    "not yet a complete fscrypt, dm-crypt",
                    "Historical fscrypt and dm-crypt fio outputs",
                ],
            },
        ],
        "scoped_out": [
            "fscrypt/dm-crypt/fs-verity/dm-integrity rows are not current matched measurements",
        ...
        "paper_anchors": [
            {
                "path": "Paper/4_Evaluation.tex",
                "terms": [
                    "Mounted storage pressure raises SQLite p99 from 6.4~ms to 13.8~ms",
                    "recovers to 8.8~ms p99",
                    "This is SQLite recovery, not general AI-inference QoS",
                ],
            },
        ],
        "scoped_out": [
            "pressure result is mounted SQLite storage pressure, not TensorRT/AI p99 recovery",
        ],
    },
    {
    ...
    },
    {
        ...
        "status": "implemented_scoped",
        "figure_table_labels": ["fig:baseline_comparison"],
        "evidence": [
            {
        ...
        "paper_anchors": [
            {
                ...
                "terms": [
                    ...
                    "1.158$\\times$ speedup",
                    "ablation rows attribute observed behavior to four mechanisms",
                ],
            },
        ],
        "scoped_out": [
        ...
        "paper_anchors": [
            {
                "path": "Paper/4_Evaluation.tex",
                "terms": [
                    "observed-range whiskers, not confidence intervals",
                    "single retained workflow artifacts, not statistical confidence claims",
                    "future headline comparisons require warmup, five repetitions, bootstrap 95\\% confidence intervals",
                ],
            },
        ],
        "scoped_out": [
        ...
        "paper_anchors": [
            {
                "path": "Paper/10_Discussion_and_Limitations.tex",
                "terms": [
                    "This case study is the same \\texttt{sqlite-mounted-qos-recovery-2026-06-27} contract",
                    "not a separate anecdotal demo",
                    "does not extend to kernel-encryption replacement",
                ],
            },
        ],
        "scoped_out": [
