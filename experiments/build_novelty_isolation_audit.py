...
RELATED_WORK_TERMS = [
    "not a stronger deployed encryption layer",
    "per-file authenticated FUSE format",
    "storage-visible latency/elastic policy",
    "optional GPU maintenance with CPU fallback",
    "externally anchored replay checks",
    "one mounted prototype",
]
...
def build_report() -> dict[str, Any]:
    ...
    checks = {
        ...
        "maturity_boundary_present": "kernel-integrated systems have a clear maturity advantage" in background,
        "full_kernel_matrix_boundary_present": "leaves a full fscrypt/dm-crypt matrix open" in related,
    }
