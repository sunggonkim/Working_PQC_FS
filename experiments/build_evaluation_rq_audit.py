...
REQUIRED_RQS = [
    ...
    {
        "id": "RQ2",
        "category": "mode-aligned baselines",
        "terms": ["mode-aligned", "baselines", "plaintext", "gocryptfs", "frozen"],
        "evidence_needles": ["frozen filesystem contract", "plaintext warm-cache row", "gocryptfs reports"],
    },
    {
        "id": "RQ3",
        "category": "QoS/hero result",
        "terms": ["qos", "hero", "sqlite", "foreground", "pressure"],
        "evidence_needles": ["\\label{sec:eval_qos}", "SQLite transaction latency", "simple controller"],
    },
    {
        "id": "RQ4",
        "category": "freshness and recovery",
        "terms": ["freshness", "recovery", "oracle", "tpm"],
        "evidence_needles": ["hardware-freshness recovery matrix", "daemon power-fault campaign", "oracle verdict"],
    },
    {
        "id": "RQ5",
        "category": "ablation and sensitivity",
        "terms": ["ablation", "sensitivity", "mechanisms", "controller"],
        "evidence_needles": ["mechanism-ablation manifest", "sensitivity bundle", "hysteresis"],
    },
]
