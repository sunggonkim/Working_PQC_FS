...
SOURCE_ANCHORS = [
    {
        ...
        "needles": ["Figure~\\ref{fig:first_page_qos}", "13.8", "8.8", "2.7"],
    },
    {
    ...
    },
    {
        "name": "central_thesis",
        "path": "Paper/1_Introduction.tex",
        "needles": ["Its thesis is that secure edge storage", "one durable authenticated format", "three operational planes"],
    },
    {
        "name": "design_insight",
        "path": "Paper/1_Introduction.tex",
    ...
    },
    {
        ...
        "path": "Paper/1_Introduction.tex",
        "needles": ["C1: Secure-storage format and placement boundary"],
    },
    {
        "name": "contribution_c2",
        "path": "Paper/1_Introduction.tex",
        "needles": ["C2: Scoped placement and workflow evidence on Thor"],
    },
    {
        "name": "contribution_c3",
        "path": "Paper/1_Introduction.tex",
        "needles": ["C3: Recovery/freshness evidence with failure labels"],
    },
    {
        "name": "contribution_c4",
        "path": "Paper/1_Introduction.tex",
        "needles": ["C4: Telemetry/QoS evidence"],
    },
    {
        "name": "not_weaker_component_stack",
        "path": "Paper/2_Background.tex",
        "needles": ["not merely gocryptfs/fscrypt plus CUDA/TPM scripts", "one evidence contract"],
    },
]
...
PDF_CHECKS = [
    {
        ...
        "needles": ["Figure 1", "SQLite p99", "13.8", "8.8", "2.7 MB/s"],
    },
    {
...
def build_report() -> dict[str, Any]:
    ...
    defensive_idx = first_index(intro_text, "The paper is intentionally conservative")
