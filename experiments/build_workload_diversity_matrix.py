...
FROZEN_SCRIPT = ROOT / "experiments" / "run_frozen_aegisq_contract.py"
SQLITE_ORACLE_SCRIPT = ROOT / "experiments" / "build_sqlite_recovery_oracle.py"
MOTIVATION_SCRIPT = ROOT / "experiments" / "run_motivation_bench.py"
QOS_SCRIPT = ROOT / "experiments" / "run_qos_sqlite_hero_bundle.py"
COMBINED_SCRIPT = ROOT / "experiments" / "run_combined_durability_bundle.py"
TENSORRT_SCRIPT = ROOT / "experiments" / "benchmark_tensorrt_interference.py"
