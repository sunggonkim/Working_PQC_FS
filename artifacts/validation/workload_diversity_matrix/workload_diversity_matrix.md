...
- `mentions_workload_diversity_manifest`: `true`
- `separates_fio_and_application_evidence`: `true`
- `mentions_sqlite_dbm_application_scope`: `true`
- `keeps_tensorrt_trace_only`: `true`
- `keeps_no_ai_recovery_claim`: `true`
...
- Scripts: `experiments/run_frozen_aegisq_contract.py`
...
- Scripts: `experiments/run_motivation_bench.py, experiments/build_sqlite_recovery_oracle.py`
...
- `script_records_sqlite_mmap_env`: `true`
...
- Scripts: `experiments/run_qos_sqlite_hero_bundle.py`
...
- Scripts: `experiments/run_combined_durability_bundle.py`
...
- Scripts: `experiments/benchmark_tensorrt_interference.py`
