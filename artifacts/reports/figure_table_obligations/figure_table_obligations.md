...
| `fig:problem_boundary` | `Paper/2_Background.tex:17` | `motivation` | problem boundary for the edge-runtime thesis | `True` | `1` | `True` |
| `fig:overall_procedure` | `Paper/3_Design.tex:9` | `design` | architecture and plane-separation figure | `True` | `1` | `True` |
| `tab:design_goals` | `Paper/3_Design.tex:19` | `design` | formal storage-protocol invariant table | `True` | `1` | `True` |
| `fig:djc_state_machine` | `Paper/3_Design.tex:57` | `design` | D/J/C/xattr publication state machine | `True` | `1` | `True` |
| `tab:memory_compat` | `Paper/3_Design.tex:78` | `design/RQ2/RQ5` | memory-path claim boundary | `True` | `1` | `True` |
